...
export function AdminOrdersClientV2({ initialOrders }: { initialOrders: DbOrder[] }) {
    ...
    <section className="adminPage">
      ...
      <div className="panel toolbar">
        <input
          ...
          placeholder="Поиск по клиенту, телефону, email или товару"
        />
      ...
      <div className="blogGrid">
        {filteredOrders.length === 0 ? (
          <div className="panel">
            <p>Заказов по текущим фильтрам нет.</p>
          </div>
        ) : null}
