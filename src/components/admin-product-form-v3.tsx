...
export function AdminProductFormV3({
  product,
  categories,
  brands
}: {
      ...
      <form className="editorGrid" onSubmit={handleSubmit}>
        <div className="panel formGrid">
          ...
          <input
            ...
            type="text"
            placeholder="Или добавьте новую категорию"
          />
          ...
          <input
            ...
            type="text"
            placeholder="Или добавьте новый бренд"
          />
          <input
            value={form.size}
        ...
        <div className="panel formGrid">
          ...
          <textarea
            ...
            rows={4}
            placeholder="Цвета, каждый с новой строки"
          />
          <input
            value={form.badge ?? ""}
          ...
          <textarea
            ...
            rows={8}
            placeholder="Характеристики, каждая с новой строки"
          />
          <p className="helperText">
            Если фото не загружено, будет использовано стандартное изображение:{" "}
            {form.image || DEFAULT_PRODUCT_IMAGE}
          </p>
